...
# id: # AR-Migration style timestamp+CamelCaseShortDescription

# antecedent: # i.e. ticket source / github issue parent / slack message URL # some reference that hints at the reasoning behind the necessity of this

# product_base_version: # branch+commit-ish sha(+appversion?) at time of definition
...
# productstakeholdersatisfied [timestamp + link to stakeholder signoff (usually in external ticketing system)]
# ### ###
